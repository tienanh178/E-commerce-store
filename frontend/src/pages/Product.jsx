...
const Product = () => {
  ...
  return productData ? (
    <div className="pt-10 transition-opacity duration-500 ease-in border-t-2 opacity-100">
      ...
      <div className="mt-20">
        <div className="flex">
          <b className="px-5 py-3 border text-small">Description</b>
          <p className="px-5 py-3 border text-small">Reviews (122)</p>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-4 px-6 py-6 text-sm text-gray-500 border">
        ...
        <p>
          ...
          details descriptions, images, prices, and any available
          variations.(e.g. sizes, colors). Each products usually has its own
